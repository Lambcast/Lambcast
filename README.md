...
[SSRN](https://ssrn.com/abstract=6446446) · [Repo](https://github.com/Lambcast/ai-infrastructure-regional-electricity-demand) · [Replication Data (Dataverse)](https://doi.org/10.7910/DVN/F8JV2T) · [Interactive Dashboard](https://bit.ly/4siJ0VL)

**[The Missing Half of the Queue: Why FERC Should Require Load-Side Interconnection Queue Disclosure](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6614823)**  
A policy brief arguing that FERC should require grid operators to publish large load interconnection queue data on the same terms currently applied to generation interconnection. Grounds the recommendation in the empirical results of the companion paper, traces thirty years of FERC precedent through Orders 888, 889, 2003, and 2023, and proposes a specific regulatory mechanism under Sections 205 and 206 of the Federal Power Act that does not require new legislation.  
[SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6614823)
...
**[Replication: Political Economy at Any Speed](https://lambcast.net/projects/econ644-replication/econ644-replication.html)**  
Full replication of Makowsky & Stratmann (2009) using 68,357 Massachusetts speeding stops. Probit with clustered standard errors, OLS with municipality fixed effects, choropleth mapping with Census shapefiles.  
Stata
